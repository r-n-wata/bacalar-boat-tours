...
import ClientSignin from "../../../components/molecules/auth/client/clientSignin";
import OperatorSignin from "../../../components/molecules/auth/operator/operatorSignin";
    ...
    >
      ...
      <div className="max-w-3xl w-full space-y-8 py-24">
        ...
        <div className="bg-white/90 border border-gray-200 rounded-xl p-8 shadow-lg backdrop-blur-sm">
          {option === "business" ? <OperatorSignin /> : <ClientSignin />}
        </div>
      </div>
    </main>
  );
